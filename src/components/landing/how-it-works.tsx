        ...
        >
          {STEPS.map((step, idx) => (
            <motion.div
              ...
              className="glass-card relative p-7 rounded-2xl text-center overflow-hidden"
            >
              {/* Step number — large background watermark */}
              <div
                className="absolute top-3 right-4 text-[5rem] font-heading leading-none font-bold opacity-[0.04] select-none pointer-events-none"
              ...
              <div className="flex justify-center mb-5">
                ...
                >
                  <span className="text-lg font-heading font-bold" style={{ color: step.color }}>
                    {step.num}
                  </span>
                </div>
              </div>
              ...
              {idx < STEPS.length - 1 && (
                <div className="hidden md:block absolute top-[4.5rem] -right-3 z-10 text-[oklch(0.35_0.01_260)]">
              ...
              <h3 className="font-heading text-xl text-[oklch(0.95_0.005_80)] mb-3">
                {step.title}
              </h3>
              <p className="text-sm text-[oklch(0.65_0.01_260)] leading-relaxed mb-4">
                {step.desc}
              </p>
              <span
                className="inline-block text-[11px] font-bold uppercase tracking-[0.15em] px-3 py-1 rounded-full"
                style={{
                  color: step.color,
                  backgroundColor: `color-mix(in oklch, ${step.color} 10%, transparent)`,
                }}
              >
                {step.time}
              </span>
