      ...
      <div className="relative max-w-5xl mx-auto">
            ...
            return (
              ...
              >
                ...
                <div className="flex items-start justify-between mb-3">
                  ...
                  {isSelected && isFree && (
                    <div className="h-6 w-6 rounded-full bg-[#32373c] flex items-center justify-center flex-shrink-0">
        ...
        >
          <button
            ...
            className="group relative inline-flex items-center justify-center h-12 px-8 text-sm font-semibold tracking-wide bg-[#32373c] text-white rounded-lg transition-all duration-300 hover:bg-[#1d2024] hover:shadow-[0_0_40px_oklch(0.62_0.22_330/0.25)] active:scale-[0.97]"
          >
